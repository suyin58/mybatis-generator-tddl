package com.dingtalk.generator.gui.bridge;

import com.dingtalk.generator.gui.model.DatabaseConfig;
import com.dingtalk.generator.gui.model.DbType;
import com.dingtalk.generator.gui.model.GeneratorConfig;
import com.dingtalk.generator.gui.util.ConfigHelper;
import com.dingtalk.generator.gui.util.DbUtil;
...
//        }
        ...
        commentGeneratorConfiguration.setConfigurationType("com.dingtalk.generator.plugins.CommentGenerator");
        context.setCommentGeneratorConfiguration(commentGeneratorConfiguration);

        // 特殊类型进行转化
        JavaTypeResolverConfiguration javaTypeResolverConfiguration = new JavaTypeResolverConfiguration();
        javaTypeResolverConfiguration.setConfigurationType("com.dingtalk.generator.plugins.JavaTypeResolverMybatisDefaultImpl");
        ...
        if (generatorConfig.isUseLombokPlugin()) {
            ...
            pluginConfiguration.setConfigurationType("com.dingtalk.generator.plugins.LombokPlugin");
        ...
        if (generatorConfig.isUseUniqueKey()) {
            ...
            updateByUniqueKeySelectivePlugin.setConfigurationType("com.dingtalk.generator.plugins.UpdateByUniqueKeySelectivePlugin");
            ...
            deleteByUniqueKeyPlugin.setConfigurationType("com.dingtalk.generator.plugins.DeleteByUniqueKeyPlugin");
            ...
            upsertByUniqueKeyPlugin.setConfigurationType("com.dingtalk.generator.plugins.UpsertByUniqueKeyPlugin");
            context.addPluginConfiguration(upsertByUniqueKeyPlugin);
        }
        // 批量插件
        PluginConfiguration batchInsertPlugin = new PluginConfiguration();
        batchInsertPlugin.setConfigurationType("com.dingtalk.generator.plugins.BatchInsertPlugin");
        ...
        if (generatorConfig.isOffsetLimit()) {
          if (DbType.MySQL.name().equals(dbType) || DbType.MySQL_8.name().equals(dbType)
              ...
              limitPlugin.setConfigurationType("com.dingtalk.generator.plugins.LimitPlugin");
        ...
        if(generatorConfig.isNeedForUpdate()) {
            if (DbType.MySQL.name().equals(dbType)|| DbType.MySQL_8.name().equals(dbType)
                ...
                selectByExampleForUpdate.setConfigurationType("com.dingtalk.generator.plugins.SelectByExampleForUpdate");
                ...
                selectByUniqueKeyForUpdatePlugin.setConfigurationType("com.dingtalk.generator.plugins.SelectByUniqueKeyForUpdatePlugin");
